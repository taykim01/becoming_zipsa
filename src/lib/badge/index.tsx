...
export default function Badge(props: {
    ...
    return (
        <div className="flex py-2 pr-7 pl-2 items-center justify-between w-full h-fit rounded-full bg-white-40">
            ...
            <div className="inline-flex flex-col justify-items-center">
                <div className={`text-sb20 ${badgeColor[props.title].color} font-fs-sb`}>{props.title}</div>
